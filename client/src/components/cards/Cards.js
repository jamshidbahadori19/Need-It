...
import {styled, Card,CardHeader,CardMedia,CardContent,CardActions,Collapse,Avatar,IconButton,IconButtonProps,Typography} from "@mui/material"
...
useEffect(()=>{
  ...
  return(
    <div>
      <button onClick={getAllCards}>get the cards</button>
      {cards.map((card)=>{
        <div key={card._id}>
          return (
